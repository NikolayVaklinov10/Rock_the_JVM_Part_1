...
object PatternMatching extends App {
  ...
  val greeting = bob match {
    case Person(n, a) if a < 21 => s"Hi, my name is $n and I am $a years old so I can't drink in the US"
    case _ => "I don't know who I am"
  }
  println(greeting)

  /*
  Some rules of Pattern Matching to consider
